...
const ACTION_PROMPTS = {
  ...
  x3: { icon:'redeem', label:'Add a $25 credit to tenant accounts with open maintenance requests over 7 days old',
  ...
  x4: { icon:'local_parking', label:'Add a parking violation for red Camaro at Riverview Apartments',
  ...
  x5: { icon:'assignment_late', label:'Help me prioritize the maintenance requests submitted via the resident portal this week',
  ...
  x6: { icon:'drafts', label:'Draft follow-up emails to all my leads that haven’t responded in over 7 days',
...
const BILLING_PROMPTS = {
  x2: { icon:'request_quote', label:'Find all unbilled maintenance requests to property owners and create the bills',
