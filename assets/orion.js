...
/* Prompts the walk skips. Every one of them stays in the sheet — someone
   browsing Prompt Suggestions still sees the whole set — they are only out
   of the click-through. */
const AUTOFILL_SKIP = [
  /* Find Answers. A demo that opens with three how-do-I answers in a row
  ...
  /* Take Action. One is enough to show what acting on data looks like, and
     ...
     repeat that shape with different nouns. */
  'x2', 'x3', 'x4', 'x5', 'x6',
];
